...
After discussion and several tryouts, we decided to cross validate within each train function (since different models have different function to cross validate most efficiently).
